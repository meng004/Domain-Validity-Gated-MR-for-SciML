...
| `kanewalaBieman2014slr` | VERIFIED | doi 10.1016/j.infsof.2014.05.006 | Kanewala & Bieman, "Testing scientific software: A systematic literature review", Information and Software Technology 56(10):1219--1232, 2014. Problem-defining IST SLR on the scientific-software oracle problem; cited in §2.3 as the baseline this paper extends with the validity gate. crossref-verified. |
| `wang2022mridentification` | VERIFIED | doi 10.1145/3514105.3514109 | Wang, Yang, Li, Liu, Yan, Fu, "A Dynamic Identification Method of Metamorphic Relation Based on Separation of Input Pattern and Output Pattern", ICWCSN 2022, pp.16--24. Authors' own prior MR-identification work; cited in §2.3 to bound the contribution (identification is prior work, not this paper's novelty). crossref-verified. |
| `fu2021burnup` | VERIFIED | doi 10.1109/IAECST54258.2021.9695750 | Fu, Yang, Li, Wang, "An Identification Method of Image-based for Output Pattern of Metamorphic Relation in Burnup Calculation Program", IAECST 2021, pp.811--818. Authors' group output-pattern MR-identification precedent for numerical solver code; cited in §2.3. crossref-verified. |
| `li2022nuclearmr` | VERIFIED | doi 10.3389/fenrg.2022.788753 | Li, Yang, Yan, Liu, Liu, Sun, "A Lightweight Verification Method Based on Metamorphic Relation for Nuclear Power Software", Frontiers in Energy Research 10:788753, 2022. Authors' own physics-derived MR construction for nuclear-power software; cited in §2.3 as self-positioning (identification, not the validity gate). openalex/crossref-verified. |
| `yan2024elliptic` | VERIFIED | doi 10.1002/stvr.1912 | Yan & Zhu, "Metamorphic Testing on Scientific Programs for Solving Second-Order Elliptic Differential Equations", Software Testing, Verification and Reliability 35(1), 2024. Closest neighbor deriving MRs from numerical models of differential equations (tests the solver, not a learned OOD surrogate); cited in §2.7. crossref-verified. |
| `stevens2025mars` | VERIFIED | doi 10.1109/ICSE-NIER66352.2025.00012 | Stevens, Kjeer, Richard, Valeev, Cohen, "Model Assisted Refinement of Metamorphic Relations for Scientific Software", ICSE-NIER 2025, pp.31--35. Recent MR-refinement-for-scientific-software competitor; cited in §2.7 to contrast with the admissibility-gate wedge. dblp-verified. |
