...
authoritative runtime claim ledger (\texttt{claim-ledger.yml}, claims \texttt{C1}--\texttt{C7})
...
PC5$\to$C7, PC6$\to$C6, and PC7$\to$ no runtime-evidence claim (a method/ethics boundary).
