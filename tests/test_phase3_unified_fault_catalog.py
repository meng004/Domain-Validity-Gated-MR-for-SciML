...
class TestPhase3UnifiedFaultCatalog(unittest.TestCase):
    ...
    def test_catalogue_size_and_breakdown(self) -> None:
        self.assertEqual(self.r["catalogue_size"], 36)
        self.assertEqual(
        ...
        self.assertEqual(len(self.r["entries"]), 36)
        self.assertEqual(self.r["trial_count"], 384)
    ...
    def test_localization_precision_recall_wilson_fields(self) -> None:
        ...
        self.assertEqual((pr["node_perm"]["tp"], pr["node_perm"]["fp"], pr["node_perm"]["fn"]), (18, 0, 0))
        self.assertEqual(pr["conservation"]["precision"]["value"], 1.0)
        self.assertAlmostEqual(pr["mirror_y"]["precision"]["value"], 68 / 74)
...
class TestPhase3TextSync(unittest.TestCase):
    def test_manuscript_and_ledger_reference_phase3_catalogue(self) -> None:
        ...
        self.assertIn("36-entry unified fault catalogue", m)
