...
- [ ] Save source/follow-up/mapped raw outputs.
- [ ] Write relation metric ledgers.
- [ ] Generate `research_assets/runs/physicsnemo-mgn-production-workflow/production_workflow_report.json`.
- [ ] Add tests for denominator counts, raw output existence, and honesty boundary.
