...
- [ ] P0c: 生产级外部 SUT extension（Task 1 feasibility audit + Task 2 candidate ledgers 已完成但 blocked；artifacts: `research_assets/runs/production-grade-sut-extension/feasibility_report.json` 与 per-object `candidate_ledger.json`；下一步需 staged official PhysicsNeMo package/runtime/checkpoint/data/API 后才能进入 Task 3-5 workflows）
