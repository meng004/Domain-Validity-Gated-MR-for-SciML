...
- Main PDF log: `Output written on main.pdf (35 pages, 414665 bytes).`
- Warning-pattern hits in final main.log: 0

## Editorial Manager structure

- Repository-level `source/` is the authoritative manuscript source; this package's `source/` directory is a generated upload copy with shared class/style/bibliography/figure files.
...
- Manuscript PDF, highlights, cover letter, declarations, author biographies, and open-science checklist are separate files.
- Supplementary evidence appendix is provided separately as PDF; its editable canonical LaTeX source is `source/supplementary.tex` at the repository root.
