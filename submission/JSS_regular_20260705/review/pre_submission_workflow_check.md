...
Target package: `submission/JSS_regular_20260705/`.
...
|---|---|---|
| JSS precheck | Pass | `tools/precheck_jss.py submission/JSS_regular_20260705/source/main.tex` passed. |
| Main PDF build | Pass | Final log reports `Output written on main.pdf (36 pages, 436478 bytes).`. |
...
| Package archive | Pass | `jss_submission_package_20260705.zip` includes the submission materials and no temporary, backup, log, or auxiliary files outside `review/`. |
