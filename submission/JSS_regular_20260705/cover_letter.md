...
The submitted main PDF is compiled in the single-column Elsevier form and is 36 pages. Detailed claim-to-evidence, closest-prior positioning, evaluation-design, effective-N, primary-result, claim-boundary, cross-program, secondary-baseline, and cross-family tables are provided as separate supplementary material so that the main manuscript remains within the JSS page guidance while the evidence boundary remains auditable.
